...
uint64_t OpenTextWindow(int w,
                        int h,
                        const char* title) {
  SyscallResult res = SyscallOpenWindow(
    8 + 8 * w,
    28 + 16 * h,
    10,
    10,
...
void DrawLines(const LinesType& lines,
               int start_line,
               uint64_t layer_id,
               int w,
               int h,
...
bool UpdateStartLine(int* start_line,
                     int height,
                     size_t num_lines) {
  while (true) {
